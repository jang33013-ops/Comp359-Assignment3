...
Node labels are represented by colours to keep nodes small/legible.
"""
...
def draw_combined_image(graphs, output_path, max_trees=100):
    ...
    # Square-ish layout keeps every miniature tree readable.
    fig, axes = plt.subplots(rows, cols, figsize=(cols * 2.4, rows * 2.4))

    # Normalize axes to a flat list for uniform handling.
    ...
    # Hide extra subplot boxes when count is not a perfect square.
